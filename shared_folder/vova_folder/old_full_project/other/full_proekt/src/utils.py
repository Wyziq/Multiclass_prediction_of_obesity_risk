...
def save_clean_df_to_notebooks(
    filename: str = "prepared_data.csv",
    *,
    column_names: Optional[str] = None,
) -> Path:
    """
    Save the cleaned dataset into the `notebooks` folder as CSV.

    Args:
        filename: CSV file name inside the notebooks folder.
        column_names: optional renaming scheme: "short_names", "long_names", or None.
    """
    ...
    target = get_data_path("notebooks", filename)
